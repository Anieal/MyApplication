...
import com.demo.manager.TcMouseManager;

public class MouseWebViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contentView = (ViewGroup) inflater.inflate(R.layout.activity_mouse_web_view, null);
    ...
    private void init() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MouseWebViewActivity.this, "onclicked ", Toast.LENGTH_LONG).show();
                showProgress(true);
                ...
                webView.setWebViewClient(new WebViewClient() {
                    ...
                    public void onReceivedError(WebView view, int errorCode,
                        ...
                        Toast.makeText(MouseWebViewActivity.this, "加载失败 ",
